...
abstract class libusb_descriptor_type {
  ...
  static const int LIBUSB_DT_INTERFACE_ASSOCIATION = 11;
...
abstract class libusb_bos_type {
  ...
  /// Platform descriptor
  static const int LIBUSB_BT_PLATFORM_DESCRIPTOR = 5;
}
...
abstract class libusb_option {
  ...
  static const int LIBUSB_OPTION_MAX = 4;
}
...
typedef Dartlibusb_log_cbFunction = void Function(
    ffi.Pointer<libusb_context> ctx, int level, ffi.Pointer<ffi.Char> str);
